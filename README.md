...
| `zfs/create_test_autosnapshots.sh` | Creates a configurable number of test snapshots on a dataset using `autosnapshot-YYYY-MM-DD_HH-MM-SS` style names for plugin testing, with settings edited at the top of the script. |
